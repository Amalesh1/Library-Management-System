...
public class IssueBook extends JFrame implements ActionListener{
	 ...
	 * 
	 */
	private static final long serialVersionUID = 7168923610931356315L;
    ...
    public IssueBook() {
		...
		t8.setFont(new Font("Serif", Font.BOLD, 14));
		t8.setColumns(10);
		...
		t9.setFont(new Font("Serif", Font.BOLD, 14));
		...
		t10.setFont(new Font("Serif", Font.BOLD, 14));
		...
		t11.setFont(new Font("Serif", Font.BOLD, 14));
		...
		t12.setFont(new Font("Serif", Font.BOLD, 14));
		...
		t13.setFont(new Font("Serif", Font.BOLD, 14));
		...
		t14.setFont(new Font("Serif", Font.BOLD, 14));
		...
		panel_1.setBorder(new TitledBorder(new LineBorder(new Color(70, 130, 180), 2, true), "Student-Deatails", TitledBorder.LEADING, TitledBorder.TOP, null, new Color(100, 149, 237)));
    ...
    public void actionPerformed(ActionEvent ae){
        try{
            ...
            while (rs.next()) {
                ...
                t5.setText(rs.getString("editionn"));
                t6.setText(rs.getString("price"));
                t7.setText(rs.getString("pagess"));
            }
            st.close();
            rs.close();
            ...
            if(ae.getSource() == b2){
                String sql = "select * from studentdetails where roll = ?";
                PreparedStatement ps = con.c.prepareStatement(sql);
                ps.setString(1, t8.getText());
                ResultSet rs = ps.executeQuery();
		
                while (rs.next()) {
                    t9.setText(rs.getString("namee"));
                    t10.setText(rs.getString("email"));
                    t11.setText(rs.getString("phone"));
                    t12.setText(rs.getString("dept"));
                    t13.setText(rs.getString("libidno"));
            ...
            if(ae.getSource() == b3){
            	try{
            		String sql = "insert into issuebook(bookid, roll, bookname, studentname, semester, dept, dateOfIssue) values(?, ?, ?, ?, ?, ?, ?)";
            		PreparedStatement st = con.c.prepareStatement(sql);
            		st.setString(1, t1.getText());
            		st.setString(2, t8.getText());
            		st.setString(3, t2.getText());
            		st.setString(4, t9.getText());
            		st.setString(5, t14.getText());
